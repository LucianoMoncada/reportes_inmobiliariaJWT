...
import com.base.dtos.CreateUserRequest;
import com.base.dtos.LoginRequest;
...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthResponse> register(@RequestBody @Valid CreateUserRequest userRequest){
